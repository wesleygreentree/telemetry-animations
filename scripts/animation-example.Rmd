...
ocean <- sf::read_sf("data/comox-ocean-shapefile.shp") # this is a shapefile of the ocean, not of land. Can manually process a shapefile of land and invert it to be a shapefile of the ocean.
